...
<div class="max-w-4xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-zinc-900">Upload Transaksi Keluar</h1>
        <p class="text-sm text-zinc-500 mt-1">Upload data transaksi keluar sekaligus lewat file Excel.</p>
    </div>
    ...
    <div class="flex items-center gap-3 mb-6">
        <div class="flex items-center gap-2">
            <span
                ...
                @if ($step === 'review') ✓ @else 1 @endif
            </span>
            <span class="text-sm font-medium {{ $step === 'upload' ? 'text-zinc-900' : 'text-zinc-500' }}">Upload File</span>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium {{ $step === 'review' ? 'text-zinc-900' : 'text-zinc-400' }}">Cek & Simpan</span>
        </div>
    </div>
    ...
    @if ($step === 'review')
        <div class="mb-3 p-3 bg-zinc-50 rounded-lg text-sm text-zinc-700 border border-zinc-100">
