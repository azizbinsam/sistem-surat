...
<body class="font-sans antialiased bg-white text-zinc-900">
        ...
        <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('register') }}"
                    class="text-sm bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-emerald-500 shadow-sm">Daftar
                    Gratis</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm">
                    ...
                    <p class="text-sm text-zinc-500">Upload data mentah, sistem kelompokkan otomatis jadi transaksi siap
                        surat.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm">
                    <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm">
                    ...
                    <p class="text-sm text-zinc-500">Satu klik, dapat 3 surat sekaligus — bisa satuan atau bulk
            ...
            <div class="max-w-4xl mx-auto px-6">
                ...
                <div class="grid sm:grid-cols-{{ min($paketList->count(), 3) }} gap-6">
                    @foreach ($paketList as $paket)
                        <div
                            class="border border-zinc-200 rounded-2xl p-8 text-center hover:border-emerald-300 hover:shadow-lg transition">
                            ...
                            <a href="{{ route('register') }}"
                                class="block bg-zinc-900 text-white py-3 rounded-lg text-sm font-medium hover:bg-emerald-600 transition">Pilih
                                Paket</a>
                        </div>
                    @endforeach
                </div>
    ...
    <footer class="py-8 bg-zinc-900 border-t border-zinc-800">
        <div class="max-w-6xl mx-auto px-6 text-center text-sm text-zinc-500">
            &copy; {{ date('Y') }} {{ \App\Models\AppSettings::current()->nama_aplikasi }}. Dibuat oleh Delix
            Studio.
        </div>
    </footer>
