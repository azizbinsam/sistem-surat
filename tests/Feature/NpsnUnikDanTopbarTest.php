...
class NpsnUnikDanTopbarTest extends TestCase
{
    ...
    public function test_pengaturan_sekolah_boleh_simpan_tanpa_ubah_data_sendiri(): void
    {
        $sekolah = Sekolah::create([
            'nama_sekolah' => 'SDN Sendiri', 'kode_sekolah' => 'SDNSENDIRI', 'npsn' => '20601111',
    ...
    {
        Sekolah::create([
            'nama_sekolah' => 'SDN Lain', 'kode_sekolah' => 'SDNLAIN', 'npsn' => '20601222',
            'nama_pemerintah' => 'X', 'nama_dinas' => 'Y', 'alamat' => 'Z', 'tempat' => 'W',
        ]);
        $sekolahSaya = Sekolah::create([
            'nama_sekolah' => 'SDN Saya', 'kode_sekolah' => 'SDNSAYA', 'npsn' => '20601333',
            'nama_pemerintah' => 'X', 'nama_dinas' => 'Y', 'alamat' => 'Z', 'tempat' => 'W',
        ]);
